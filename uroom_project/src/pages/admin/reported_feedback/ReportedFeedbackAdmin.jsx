      ...
      <Table className="bg-white">
        <thead>
          <tr>
            ...
            <th>Description</th>
            <th className="text-center" style={{width: '30px'}}>Rating</th>
            <th className="text-center" style={{width: '180px'}}>Date</th>
            <th className="text-center" style={{width: '30px'}}>Likes</th>
            <th className="text-center" style={{width: '30px'}}>Dislike</th>
            <th className="text-center" style={{width: '30px'}}>Reports</th>
