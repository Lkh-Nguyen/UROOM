...
const BookingBill = () => {
  ...
  return (
    ...
    >
      <Header />
      <div className="flex-grow-1 d-flex align-items-center justify-content-center content-wrapper" style={{marginTop: '100px', marginBottom: '100px'}}>
        <Button
          variant="light"
          className="position-absolute rounded-pill d-flex align-items-center ms-3 mt-"
          style={{ zIndex: 100, top: 60, left: 10 }}
        >
