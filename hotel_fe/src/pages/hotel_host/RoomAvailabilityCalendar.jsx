                  ...
                  <Col md={6}>
                    <Card className="mb-3">
                      ...
                      <Card.Body>
                        ...
                        <p>
                          <strong>ID Number:</strong> {checkInBooking.idNumber}
                        </p>
                        <p>
                  ...
                  <Col md={6}>
                    <Card className="mb-3">
                      ...
                      <Card.Body>
                        ...
                        <p>
                          <strong>ID Number:</strong> {checkOutBooking.idNumber}
                        </p>
                        <p>
                          <strong>Phone:</strong> {checkOutBooking.phoneNumber}
                        </p>
                        <p>
                  ...
                  <Col md={6}>
                    <Card className="mb-3">
                      ...
                      <Card.Body>
                        ...
                        <p>
                          <strong>Guests:</strong> {checkOutBooking.guestCount}
                        </p>
                      </Card.Body>
                    </Card>
                  </Col>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="text-end">
                            $
                            {calculateBill(checkOutBooking).roomCharge.toFixed(
                              2
                            )}
                          </td>
                        </tr>
                        ...
                        <tr className="table-primary">
                          ...
                          <td className="text-end fw-bold">
                            ${calculateBill(checkOutBooking).balance.toFixed(2)}
                          </td>
                        </tr>
                      </tbody>
                    </Table>
