const feedbackContents = [
    ...
    const hotelDescriptions = [
      "Located in the heart of the city, our hotel offers a luxurious getaway with world-class amenities, exquisite cuisine, and personalized service. Whether you're here for business or leisure, expect an exceptional experience with panoramic city views and top-notch hospitality.",
      "Experience the magnificent beauty of royal luxury with our premium services. From luxurious room suites to refined dining options, every detail is carefully crafted to ensure a classy and memorable stay. Relax to the fullest with our spa and wellness services.",
      "A peaceful retreat, providing tranquility and comfort amidst the vibrant city life. The hotel features elegantly furnished rooms, a quiet rooftop garden, and various entertainment activities to help you relax and enjoy your stay.",
      ...
      "A high-rise haven offering spectacular panoramic views of the city skyline. Whether you're enjoying drinks at the rooftop bar or relaxing in your luxurious suite, our hotel offers the perfect blend of style, comfort, and convenience.",
      "An exclusive experience for travelers seeking unparalleled luxury and sophistication. The hotel provides exclusive access to premium lounges, upscale restaurants, and personal assistant services to cater to your every need.",
...
const facilitiesName = [
  { name: "Free Wi-Fi", icon: "FaWifi", description: "Free high-speed internet for guests." },
  { name: "Swimming Pool", icon: "FaSwimmingPool", description: "Spacious, clean, and modern swimming pool." },
  { name: "Parking Lot", icon: "FaParking", description: "Free parking available for staying guests." },
  { name: "24/7 Room Service", icon: "FaConciergeBell", description: "Room service available at all times." },
  { name: "Restaurant", icon: "FaUtensils", description: "Restaurant serving a wide variety of delicious dishes." },
  { name: "Fitness Center", icon: "FaDumbbell", description: "Gym fully equipped with modern facilities." },
  { name: "Airport Shuttle", icon: "FaShuttleVan", description: "Convenient airport transfer service for guests." },
  { name: "Spa & Wellness Center", icon: "FaSpa", description: "Relaxing spa treatments and wellness options." },
  { name: "Laundry Service", icon: "FaHandsWash", description: "Professional laundry and dry-cleaning service." },
  { name: "Conference Room", icon: "FaChalkboardTeacher", description: "Spacious and well-equipped conference facilities." },
  { name: "Pet-Friendly", icon: "FaDog", description: "Pets are welcome in designated rooms." },
  { name: "Mini Bar", icon: "FaWineBottle", description: "In-room mini bar with snacks and beverages." }
]
...
const roomFacilities = [
  ...
  },
  {
    ...
    for (let i = 0; i < servicesName.length; i++) {
      let priceMultiplier = Math.floor(Math.random() * 500) + 1; // 1 to 5
      let randomPrice = priceMultiplier * 1000; // Always divisible by 1000
